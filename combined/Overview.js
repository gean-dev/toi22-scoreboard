...
var Overview = new function () {
    ...
    self.init = function () {
        ...
        set.attr({"font-size": "12px", "fill": "#FFFFFF", "stroke": "none", "font-family": "sans-serif", "opacity": 0});
    ...
    self.update_score_axis = function () {
        ...
        if (self.score_axis) {
            ...
            self.score_axis = self.paper.path(d).attr(
                {"fill": "none", "stroke": "#bbbbbb", "stroke-width": 3, "stroke-linecap": "round"});
        }
    };
    ...
    self.create_score_chart = function () {
        ...
        self.score_line = self.paper.path(s_path).attr({"fill": "none", "stroke": "#aaaaaa", "stroke-width": 2, "stroke-linecap": "round"});
        s_path += Raphael.format(" L {0},{1} {0},{2} Z", self.PAD_L, self.PAD_T, self.height - self.PAD_B);
        self.score_back = self.paper.path(s_path).attr({"fill": "0-#777777-#8A8A8A", "stroke": "none"});
